...
@section('main')
      ...
      <div class="row pt-4">
        <div class="col-12 text-center pt-4">
          <h1 class="pt-4">Edit information of Backgorund-table</h1>
        </div>
      </div>

      <div class="row container">
    <div class="col-12 col-lg-10">
    <form id="editform" class="container-fluid" method="post" action="/ABM/service/editBackground" enctype="multipart/form-data">
    ...
    <div class="row my-3 flex-column flex-lg-row flex-wrap">
      ...
      <div class="col-6 col-lg-3 pt-lg-5 pl-5">
        <a href="/ABM/service/editBackground/{{$background->id}}/removePhoto" class=" btn btn-primary">Remove</a>
      </div>
    </div>
