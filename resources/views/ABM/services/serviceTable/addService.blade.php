...
@section('main')
  ...
  <div class="row container pl-5">
    <div class="col-12">
  <form method="post" action="{{action('ABM\ABMservicecontroller@addService')}}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
      <label for="description">Intro part 1</label>
  ...
  <div class="col-12">
    ...
    <a href="/ABM/services/mainServices" class="btn btn-secondary col-3">Back</a>
  </div>
    </form>
  </div>
