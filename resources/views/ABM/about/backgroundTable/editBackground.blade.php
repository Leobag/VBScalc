...
@section('main')
    ...
    <form id="editform" class="container-fluid" method="post" action="/ABM/about/editBackground" enctype="multipart/form-data">
    ...
    <div class="row my-3 flex-column flex-lg-row flex-wrap">
      ...
      <div class="col-6 col-lg-3 pt-lg-5 pl-5">
        <a href="/ABM/about/editBackground/{{$background->id}}/removePhoto" class=" btn btn-primary">Remove</a>
      </div>
    </div>
